...
#
# Temporary script to build the 15.25 release in 32bit. only for release 15.25.0
#
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
...
FULL_INSTALLER="http://officecdn.microsoft.com/pr/C1297A47-86C4-4C1F-97FA-950631F94777/OfficeMac/Microsoft_Office_2016_15.25.0_160818_Installer32.pkg"

# Define output name based on naming convention
OUTNAME="${PRODUCT}_${FULL_VERSION}_${PKG_LANGUAGE}_(32-bit)"
